...
from apps.category.forms import AddCategoryForm,AddSubCategoryForm
from apps.category.models import Category,Sub_category
from django.shortcuts import redirect, render
from apps.orders.models import Order, OrderProduct
from apps.vendors.forms import AddProductForm
from apps.store.models import Product,Images, Variation, VariationSample
